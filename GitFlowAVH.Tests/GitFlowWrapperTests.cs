...
namespace GitFlowAVH.Tests
{
    ...
    public class GitFlowWrapperTests
    {
        ...
        public void RunInstallScript()
        {
            ...
            var proc = new Process
            {
                StartInfo = new ProcessStartInfo
                {
                    ...
                    Arguments = String.Format(@"-ExecutionPolicy ByPass -NoLogo -NoProfile  -File "".\Dependencies\Install.ps1"" ""{0}""", gitInstallPath),
                    Verb = "runas",
        ...
        {
            var gf = new GitFlowWrapper(sampleRepoPath);
            const string query = "Hooks and filters directory? [../../../.git/hooks]";
